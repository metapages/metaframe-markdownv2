...
globalThis.addEventListener("resize", handleResize, false);
...
To have your script cleaned up because of new script (when editing), set a function `scriptUnload` on the globalThis object, this will be called prior to a new script added:
